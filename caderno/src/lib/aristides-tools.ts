  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        dizimo: { type: "boolean", description: "se essa receita gera dízimo — false para reembolso, devolução de empréstimo etc. Padrão true." },
      },
      ...
      return {
        acao: {
          ...
          dados: {
            ...
            dia: input.dia != null ? Number(input.dia) : null,
            quando: str(input, "quando") || (input.dia != null ? `dia ${input.dia}` : "sem data"),
            q: str(input, "q") as "Q1" | "Q2",
            dizimo: bool(input, "dizimo", true),
          },
        },
