 ...
 * Gerente: 2 tomadas, 1 ponto de rede"), pelo mesmo canal de sempre. Como um
 * tema pode ter mais de uma pergunta e a grade só faz sentido numa delas, a
 * interface só mostra a tabela quando a IA marca `mostrarTabela true` naquela
 * mensagem específica — o objetivo do tema precisa deixar claro em qual
 * pergunta isso vale (ver tema 19).
 *
