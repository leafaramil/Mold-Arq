  ...
  return (
    <Centro>
      <div style={{ textAlign: "center" }}>
        <div style={{ fontFamily: fontSerif, fontSize: 28, fontWeight: 600, color: T.ink, marginBottom: 4 }}>Cotação</div>
...
export function OfertaBiometria({ onAtivar, onDispensar }: { onAtivar: () => Promise<boolean>; onDispensar: () => void }) {
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(31,58,43,0.55)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 600, padding: 24 }}>
      <div style={{ background: T.paper, borderRadius: 20, padding: 22, width: "100%", maxWidth: 330, textAlign: "center" }}>
        ...
        <div style={{ fontSize: 11.5, color: T.inkSoft, marginBottom: 16, lineHeight: 1.5 }}>
          Assim só quem tiver a digital ou o rosto cadastrado neste aparelho consegue abrir a lista.
        </div>
